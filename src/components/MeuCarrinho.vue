<script setup>
import { carrinho, removerItemCarrinho, atualizaQuantidadeItem, mostraCarrinho, formularioAparece } from '@/_data/carrinho.js'
...
<template>
  <div v-if="mostraCarrinho" class="carrinho">
    <h2>Meu carrinho</h2>
    <div class="wrap-carrinho">
      ...
      <m-button class="perigo" @click="formularioAparece()"> Finalizar compra </m-button>
